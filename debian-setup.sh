...
# 2. Install packages
sudo apt-get install curl rclone gimp inkscape vlc transmission-gtk blender audacious signal-desktop libreoffice-writer firefox-esr qt5ct qt5-style-kvantum neovim manuskript
